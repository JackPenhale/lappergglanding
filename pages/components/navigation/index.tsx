        ...
        <div className={tw(`flex items-center justify-between h-24`)}>
          <div className={tw(`flex items-center`)}>
            ...
            <div className={tw(`hidden md:block`)}>
              <div className={tw(`ml-10 flex items-baseline space-x-4`)}>
                <h1
                  className={tw(
                    `font-sans font-bold text-2xl md:text-3xl lg:text-4xl text-center leading-snug text-gray-800`,
                  )}
                >
                  Lapper.gg
                </h1>
          ...
          <div className={tw(`hidden md:block`)}>
            <div className={tw(`ml-4 flex items-center md:ml-6`)}>
              <Button modifier="border-0 mr-2">Tutorial</Button>
              <Button modifier="border-0 mr-2">Join</Button>
              <Button modifier="border-0 mr-2">Host</Button>
